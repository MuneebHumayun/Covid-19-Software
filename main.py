...
#-----Frame-------------------------------------------
s = ttk.Style()
s.configure('TNotebook.Tab', font=('Fat Basic','15'))
...
for i in match:
   ...
   world.append(data)
#-----------------------------------------------------
all_=Frame(tab, bg='white',width="1500",height="400")
...
for i in continents:
   if i[0].lower()=='world':
      break
Label(root,text="World COVID-19 Data Analytics",fg="black",bg="white",font=('Fat Basic',25, "bold")).pack()
Label(root,text="Coronavirus Cases : "+str(i[1]),bg='white',fg="black",font=('Fat Basic',25, "bold")).place(x=10,y=50)
Label(root,text="Deaths : "+str(i[3]),fg="red",bg='white',font=('Fat Basic',25, "bold")).place(x=10,y=100)
Label(root,text="Recovered : "+str(i[5]),fg="green",bg='white',font=('Fat Basic',25, "bold")).place(x=10,y=150)
tree.pack()
root.mainloop()
